...
var provider = new Web3.providers.HttpProvider("https://jfcjgmhmon.localtunnel.me");
// var provider = new Web3.providers.HttpProvider("http://localhost:8545");
const web3   = new Web3();
// web3.setProvider(new web3.providers.HttpProvider('http://localhost:4000'));
web3.setProvider(new web3.providers.HttpProvider('https://jfcjgmhmon.localtunnel.me'));
